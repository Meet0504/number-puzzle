...
export default function App({ navigation }) {
  ...
  const setHandler = () => {
    let copydata = []
    for (let i = 0; i < 63; i++) {
      let value = Math.round(Math.random() * 62 + 1)
      while (copydata.includes(value)) {
        value = Math.round(Math.random() * 62 + 1)
      }
      copydata.push(value)
    }
    copydata.push('')
  ...
  const checkwin = (copydata) => {
    if (copydata[0] === 1 && copydata[1] === 2 && copydata[2] === 3 && copydata[3] === 4 && copydata[4] === 5 && copydata[5] === 6 && copydata[6] === 7 && copydata[7] === 8 && copydata[8] === 9 && copydata[9] === 10 && copydata[10] === 11
      ...
      && copydata[41] === 42 && copydata[42] === 43 && copydata[43] === 44 && copydata[44] === 45 && copydata[45] === 46 && copydata[46] === 47 && copydata[47] === 48 && copydata[48] === 49 && copydata[49] === 50 && copydata[50] === 51
      && copydata[51] === 52 && copydata[52] === 53 && copydata[53] === 54 && copydata[54] === 55 && copydata[55] === 56 && copydata[56] === 57 && copydata[57] === 58 && copydata[58] === 59 && copydata[59] === 60 && copydata[60] === 61
      && copydata[61] === 62 && copydata[62] === 63 && copydata[63] === '') {
        AsyncStorage.setItem('moves8',moves.toString())
        AsyncStorage.setItem('time8',counter.toString())
        AsyncStorage.setItem('lastpuzzle','puzzle8')
        setHandler()
  ...
  const numberHandler41 = () => {
    let copydata = [...number]
    if(copydata[49]===''){
      const swapvalue=copydata[49]
      copydata[49]=copydata[41]
  ...
  const numberHandler42 = () => {
    let copydata = [...number]
    if(copydata[50]===''){
      const swapvalue=copydata[50]
      copydata[50]=copydata[42]
  ...
  const numberHandler43 = () => {
    let copydata = [...number]
    if(copydata[51]===''){
      const swapvalue=copydata[51]
      copydata[51]=copydata[43]
  ...
  const numberHandler44 = () => {
    let copydata = [...number]
    if(copydata[52]===''){
      const swapvalue=copydata[52]
      copydata[52]=copydata[44]
  ...
  const numberHandler45 = () => {
    let copydata = [...number]
    if(copydata[53]===''){
      const swapvalue=copydata[53]
      copydata[53]=copydata[45]
  ...
  const numberHandler46 = () => {
    let copydata = [...number]
    if(copydata[54]===''){
      const swapvalue=copydata[54]
      copydata[54]=copydata[46]
  ...
  const numberHandler47 = () => {
    let copydata = [...number]
    if(copydata[55]===''){
      const swapvalue=copydata[55]
      copydata[55]=copydata[47]
  ...
  const numberHandler48 = () => {
    let copydata = [...number]
    if(copydata[56]===''){
      const swapvalue=copydata[56]
      copydata[56]=copydata[48]
  ...
  const numberHandler49 = () => {
    let copydata = [...number]
    if(copydata[57]===''){
      const swapvalue=copydata[57]
      copydata[57]=copydata[49]
      copydata[49]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[48]===''){
      const swapvalue=copydata[48]
      copydata[48]=copydata[49]
      copydata[49]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler50 = () => {
    let copydata = [...number]
    if(copydata[58]===''){
      const swapvalue=copydata[58]
      copydata[58]=copydata[50]
      copydata[50]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[49]===''){
      const swapvalue=copydata[49]
      copydata[49]=copydata[50]
      copydata[50]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler51 = () => {
    let copydata = [...number]
    if(copydata[59]===''){
      const swapvalue=copydata[59]
      copydata[59]=copydata[51]
      copydata[51]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[50]===''){
      const swapvalue=copydata[50]
      copydata[50]=copydata[51]
      copydata[51]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler52 = () => {
    let copydata = [...number]
    if(copydata[60]===''){
      const swapvalue=copydata[60]
      copydata[60]=copydata[52]
      copydata[52]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[51]===''){
      const swapvalue=copydata[51]
      copydata[51]=copydata[52]
      copydata[52]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler53 = () => {
    let copydata = [...number]
    if(copydata[61]===''){
      const swapvalue=copydata[61]
      copydata[61]=copydata[53]
      copydata[53]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[52]===''){
      const swapvalue=copydata[52]
      copydata[52]=copydata[53]
      copydata[53]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler54 = () => {
    let copydata = [...number]
    if(copydata[62]===''){
      const swapvalue=copydata[62]
      copydata[62]=copydata[54]
      copydata[54]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[53]===''){
      const swapvalue=copydata[53]
      copydata[53]=copydata[54]
      copydata[54]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler55 = () => {
    let copydata = [...number]
    if(copydata[63]===''){
      const swapvalue=copydata[63]
      copydata[63]=copydata[55]
      copydata[55]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[47]===''){
      const swapvalue=copydata[47]
      copydata[47]=copydata[55]
      copydata[55]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler56 = () => {
    let copydata = [...number]
    if(copydata[57]===''){
      const swapvalue=copydata[57]
      copydata[57]=copydata[56]
      copydata[56]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[48]===''){
      const swapvalue=copydata[48]
      copydata[48]=copydata[56]
      copydata[56]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler57 = () => {
    let copydata = [...number]
    if(copydata[58]===''){
      const swapvalue=copydata[58]
      copydata[58]=copydata[57]
      copydata[57]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[49]===''){
      const swapvalue=copydata[49]
      copydata[49]=copydata[57]
      copydata[57]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler58 = () => {
    let copydata = [...number]
    if(copydata[59]===''){
      const swapvalue=copydata[59]
      copydata[59]=copydata[58]
      copydata[58]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[57]===''){
      const swapvalue=copydata[57]
      copydata[57]=copydata[58]
      copydata[58]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler59 = () => {
    let copydata = [...number]
    if(copydata[60]===''){
      const swapvalue=copydata[60]
      copydata[60]=copydata[59]
      copydata[59]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[51]===''){
      const swapvalue=copydata[51]
      copydata[51]=copydata[59]
      copydata[59]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler60 = () => {
    let copydata = [...number]
    if(copydata[61]===''){
      const swapvalue=copydata[61]
      copydata[61]=copydata[60]
      copydata[60]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[59]===''){
      const swapvalue=copydata[59]
      copydata[59]=copydata[60]
      copydata[60]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler61 = () => {
    let copydata = [...number]
    if(copydata[62]===''){
      const swapvalue=copydata[62]
      copydata[62]=copydata[61]
      copydata[61]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[53]===''){
      const swapvalue=copydata[53]
      copydata[53]=copydata[61]
      copydata[61]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler62 = () => {
    let copydata = [...number]
    if(copydata[63]===''){
      const swapvalue=copydata[63]
      copydata[63]=copydata[62]
      copydata[62]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[54]===''){
      const swapvalue=copydata[54]
      copydata[54]=copydata[62]
      copydata[62]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
  ...
  const numberHandler63 = () => {
    let copydata = [...number]
    if(copydata[55]===''){
      const swapvalue=copydata[55]
      copydata[55]=copydata[63]
      copydata[63]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    if(copydata[62]===''){
      const swapvalue=copydata[62]
      copydata[62]=copydata[63]
      copydata[63]=swapvalue
      setnumber(copydata)
      setmoves(moves+1)
    }
    ...
    <View style={styles.container}>
     ...
     <View style={styles.text}><Text style={{fontSize:20,fontWeight: 'bold'}}>Seconds: {counter}</Text></View>
      ...
      <TouchableOpacity
        ...
        <TouchableOpacity
          onPress={() => numberHandler49()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[49]}</Text>{setbg(number[49])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler50()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[50]}</Text>{setbg(number[50])}</TouchableOpacity>
         <TouchableOpacity
          onPress={() => numberHandler51()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[51]}</Text>{setbg(number[51])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler52()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[52]}</Text>{setbg(number[52])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler53()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[53]}</Text>{setbg(number[53])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler54()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[54]}</Text>{setbg(number[54])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler55()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[55]}</Text>{setbg(number[55])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler56()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[56]}</Text>{setbg(number[56])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler57()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[57]}</Text>{setbg(number[57])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler58()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[58]}</Text>{setbg(number[58])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler59()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[59]}</Text>{setbg(number[59])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler60()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[60]}</Text>{setbg(number[60])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler61()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[61]}</Text>{setbg(number[61])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler62()}
          activeOpacity={1}
          style={styles.code}
        ><Text style={styles.textField}>{number[62]}</Text>{setbg(number[62])}</TouchableOpacity>
        <TouchableOpacity
          onPress={() => numberHandler63()}
          activeOpacity={1}
          style={styles.empty}
        ><Text style={styles.textField}>{number[63]}</Text>{setbg(number[63])}</TouchableOpacity>
      </View>
      </View>
